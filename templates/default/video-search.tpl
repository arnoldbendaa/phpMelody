			...
			{foreach from=$results key=k item=video_data}
			  <li>
				<div class="pm-li-video">
				    ...
				    <a href="{$video_data.video_href}" class="pm-thumb-fix pm-thumb-234"><span class="pm-thumb-fix-clip"><img src="{$video_data.thumb_img_url}" alt="{$video_data.attr_alt}" width="234"><span class="vertical-align"></span></span></a>
				    </span>
