        ...
        <div class="main">
            <div class="wrap-heading clearfix">
                <div class="switch-blocks">
                    <a class="active">Casinos</a>
                </div>
                <div class="sortings-navbar magic-line">
                    <div class="sortings-navbar-inner">
                        <div class="sorting {if $order=='date'||$order==''}active{/if}">
                            <a href="{$smarty.const._URL}/casinos.php?sortby=date" aria-expanded="false"  class="sorting-choice">Newest</a>
                        </div>
                        <div class="sorting {if $order=='rating'}active{/if}">
                            <a href="{$smarty.const._URL}/casinos.php?sortby=rating"  class="sorting-choice" aria-expanded="false">Top Rated</a>
                        </div>
                        <div class="sorting {if $order=='views'}active{/if}">
                            <a href="{$smarty.const._URL}/casinos.php?sortby=views"  class="sorting-choice" aria-expanded="false">Most Popular</a>
                        </div>
                        <div class="sorting {if $order=='title'}active{/if}">
                            <a href="{$smarty.const._URL}/casinos.php?sortby=title" class="sorting-choice">Title</a>
                        </div>
                    </div>
            ...
            <div class="wrap-thumbs">
                <div class="thumbs-lists">
                    {foreach from=$casinos_data key=k item=category_data}
