        ...
        <div class="main">
            <div class="wrap-heading clearfix">
                <div class="switch-blocks">
                    <a class="active">Providers</a>
                </div>
                <div class="sortings-navbar magic-line">
                    <div class="sortings-navbar-inner">
                        <div class="sorting {if $order=='date'||$order==''}active{/if}">
                            <a href="{$smarty.const._URL}/providers.php?sortby=date" aria-expanded="false"  class="sorting-choice">Newest</a>
                        </div>
                        <div class="sorting {if $order=='rating'}active{/if}">
                            <a href="{$smarty.const._URL}/providers.php?sortby=rating"  class="sorting-choice" aria-expanded="false">Top Rated</a>
                        </div>
                        <div class="sorting {if $order=='views'}active{/if}">
                            <a href="{$smarty.const._URL}/providers.php?sortby=views"  class="sorting-choice" aria-expanded="false">Most Popular</a>
                        </div>
                        <div class="sorting {if $order=='title'}active{/if}">
                            <a href="{$smarty.const._URL}/providers.php?sortby=title" class="sorting-choice">Title</a>
                        </div>
                    </div>
            ...
            <div class="wrap-thumbs">
                <div class="thumbs-lists">
                    {foreach from=$providers_data key=k item=category_data}
            ...
            <div class="sidebar-block">
                ...
                <ul class="sidebar-lists">
                    <li class="sidebar-lists-item">
                        <a  href="{$providers_data[1].url}" class="sidebar-lists-link clearfix"><span class="name wrap-icon">
							<svg class="svg-icon" width="40px" height="37px">
								<use xlink:href="#list"></use>
							</svg>
							<span class="text-truncate">{smarty_fewchars s=$providers_data[1].name length=32}</span></span>
                        </a>
                    </li>
