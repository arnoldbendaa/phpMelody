...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    function(g) {
        ...
        r.prototype = {
            ...
            drawLabels: function() {
                if (this.options) {
                    var d, a = this.options.values.length,
            ...
            validate: function() {
                var e, f, a = this.options,
                    ...
                    d = a.values,
                    c = d.length;
                if ("string" == typeof a.min && (a.min = +a.min), "string" == typeof a.max && (a.max = +a.max), "string" == typeof a.from && (a.from = +a.from), "string" == typeof a.to && (a.to = +a.to), "string" == typeof a.step && (a.step = +a.step), "string" == typeof a.from_min && (a.from_min = +a.from_min), "string" == typeof a.from_max && (a.from_max = +a.from_max), "string" == typeof a.to_min && (a.to_min = +a.to_min), "string" == typeof a.to_max && (a.to_max = +a.to_max), "string" == typeof a.keyboard_step && (a.keyboard_step = +a.keyboard_step), "string" == typeof a.grid_num && (a.grid_num = +a.grid_num), a.max < a.min && (a.max = a.min), c)
                    for (a.p_values = [], a.min = 0, a.max = c - 1, a.step = 1, a.grid_num = a.max, a.grid_snap = !0, f = 0; c > f; f++) e = +d[f], isNaN(e) ? e = d[f] : (d[f] = e, e = this._prettify(e)), a.p_values.push(e);
        ...
        e.fn[o] = function(t) {
            ...
            e(n)[o](), e.extend(e.expr[":"], {
                ...
                mcsInSight: e.expr[":"].mcsInSight || function(t) {
                    ...
                    return l.length ? (o = [r.outerHeight(!1), r.outerWidth(!1)], n = [l[0].offsetTop + oe(r)[0], l[0].offsetLeft + oe(r)[1]], a = [l.parent()[0].offsetHeight, l.parent()[0].offsetWidth], i = [o[0] < a[0] ? [.9, .1] : [.6, .4], o[1] < a[1] ? [.9, .1] : [.6, .4]], n[0] - a[0] * i[0][0] < 0 && n[0] + o[0] - a[0] * i[0][1] >= 0 && n[1] - a[1] * i[1][0] < 0 && n[1] + o[1] - a[1] * i[1][1] >= 0) : void 0
                },
    ...
    function(t, e) {
        ...
        return n.extend(l, e.prototype), l.option = function(t) {
            ...
            var i = s(r);
            return i.defaults = n.extend({}, r.defaults), n.extend(i.defaults, e),
                i.compatOptions = n.extend({}, r.compatOptions), i.namespace = t, i.data = r.data, i.Item = s(o), n.htmlInit(i, t), h && h.bridget && h.bridget(t, i), i
        }, r.Item = o, r
    }),
    function(t, e) {
    ...
    var b = function() {
            ...
            return function() {
                ...
                function b(a, b, c) {
                    c.get("debug") && window.console && console.warn && void 0, this.initSelection = c.get("initSelection"), this._isInitialized = !1, a.call(this, b, c)
                }
                ...
                function b(a, b, c) {
                    ...
                    "hidden" === b.prop("type") && c.get("debug") && console && console.warn && void 0, a.call(this, b, c)
                }
                return b.prototype.current = function(b, c) {
                    function d(b, c) {
                        var e = [];
                ...
                function a(a, b, c) {
                    c.get("debug") && window.console && console.warn && void 0, a.call(this, b, c)
                }
                return a.prototype.query = function(a, b, c) {
                    b.callback = c;
    ...
    for (var initMainMenu = function() {
        $("#nav-toggle").click(function(ev) {
            ev.preventDefault(), $(".wrapper").toggleClass("show-navigation")
        }), $("#open-menu").click(function(ev) {
            ev.preventDefault(), $(".wrapper").addClass("show-navigation")
        }), $(".overcover").on("click", function(ev) {
            ev.preventDefault(), $(".wrapper").removeClass("show-navigation")
        })
    }, initRanges = function() {
        ...
        $range.ionRangeSlider({
            ...
            $parent = $this.closest(".filter-range"), $parent.find(".min-range").text(value[0]), $parent.find(".max-range").text(value[1])
        })
    }, initNavbarCollapse = function() {
        $("#menu-btn").on("click", function() {
            $(".navbar-collapse").toggleClass("expand"), $(this).toggleClass("active")
        }), $("#search-btn").on("click", function() {
            $(".navbar-collapse").toggleClass("showsearch"), $(this).toggleClass("active")
        ...
        var swiper = new Swiper(".swiper-container", {
            ...
            tagsSearch = new Swiper(".tags-search-container", {
                nextButton: ".swiper-button-next",
                prevButton: ".swiper-button-prev",
                slidesPerView: "auto",
                spaceBetween: 0,
        ...
        $("#settings-toggle").click(function() {
            setTimeout(function() {
                void 0 !== swiper.update && swiper.update(), void 0 !== tagsSearch.update && (tagsSearch.update(), tagsSearch.slideNext(), tagsSearch.slidePrev())
            }, 1201)
        })
    }, initSelect = function() {
        ...
        setWidthImages(), $(window).resize(function() {
            setWidthImages()
        })
        ...
        $masonry = $(".masonry").masonry({
            ...
            ev.preventDefault(), $(this).toggleClass("open"), $(".wrapper").toggleClass("show-filter"), setTimeout(function() {
                $masonry.masonry()
            }, 1201)
        }), $("#nav-toggle-filter").click(function(ev) {
            ev.preventDefault(), $(".wrapper").toggleClass("show-filter"), $("#settings-toggle").removeClass("open"), setTimeout(function() {
                $masonry.masonry()
            }, 1201)
        }), $(".overcover-filter").on("click", function() {
            $(".wrapper").removeClass("show-filter"), $("#settings-toggle").removeClass("open"), setTimeout(function() {
                $masonry.masonry()
            }, 1201)
        });
        $(".masonry-fixed-page").masonry({
        ...
        function initMagicLine_MM() {
            $activeItem_MM.exists() ? $magicLine_MM.width($activeItem_MM.width()).css("left", $activeItem_MM.position().left + parseInt($activeItem_MM.css("borderLeftWidth"))).data("origLeft", $magicLine_MM.position().left).data("origWidth", $magicLine_MM.width()) : $magicLine_MM.width(0).css("left", 0).data("origLeft", 0).data("origWidth", 0)
        }
        if (window.innerWidth > 657 && $(".sortings-navbar").each(function(index, element) {
                function initMagicLine() {
                    $magicLine.width($activesorting.width()).css("left", $activesorting.position().left + parseInt($activesorting.css("borderLeftWidth"))).data("origLeft", $magicLine.position().left).data("origWidth", $magicLine.width())
                }
                var $el, leftPos, newWidth;
                $(element).append("<div class='magic-line-sorting'></div>");
                var $magicLine = $(element).find(".magic-line-sorting"),
                    $activesorting = $(element).find(".sorting.active");
                initMagicLine(), $(window).resize(function() {
                    initMagicLine()
                }), $(element).find(".sorting").hover(function() {
                    $el = $(this), leftPos = $el.position().left + parseInt($el.css("borderLeftWidth")), newWidth = $el.width(), $magicLine.stop().animate({
                        left: leftPos,
                        width: newWidth
                    })
                }, function() {
            ...
            }), window.innerWidth > 1197) {
            var $el_MM, leftPos_MM, newWidth_MM;
            $(".nav-drop").append("<div class='magic-line-MM'></div>");
            var $magicLine_MM = $(".magic-line-MM"),
                $activeItem_MM = $(".nav-drop li.active");
            $(".nav-item").on("click", function() {
                initMagicLine_MM()
            }), $(".nav-drop li:visible").hover(function() {
                $el_MM = $(this), leftPos_MM = $el_MM.position().left + parseInt($el_MM.css("borderLeftWidth")), newWidth_MM = $el_MM.width(), $magicLine_MM.stop().animate({
                    left: leftPos_MM,
                    width: newWidth_MM
                })
            }, function() {
        ...
        $(".unfollow input").on("change", function() {
            $this = $(this), $(this).is(":checked") ? $this.parents(".fcustominp-label-block").addClass("active") : $this.parents(".fcustominp-label-block").removeClass("active")
        })
    }, initMovable = function() {
        var $movable = $(".movable-top, .movable-bottom"),
            movableFunc = function() {
                $movable.each(function() {
                    var heightDiff;
                    if ($(this).hasClass("movable-top"))
                        if (heightDiff = $(this).parent().height() - $(this).outerHeight(), heightDiff > 0) {
                            var parentTopOffset = $(this).parent().offset().top - $(document).scrollTop() - 84,
                                maxOffset = $(this).parent().height() - $(this).outerHeight();
                            if (0 > parentTopOffset) {
                    ...
                    else if (heightDiff = $(this).parent().height() - $(this).outerHeight(), heightDiff > 0) {
                        var windowBottom = $(window).height() + $(document).scrollTop(),
                            movableBottom = $(this).height() + $(this).parent().offset().top,
                            diff = windowBottom - movableBottom;
                        diff > 0 ? (diff = Math.min(diff, heightDiff), $(this).css({
                            top: diff + "px"
                        })) : $(this).css({
                            top: "0px"
                        })
        ...
        $movable.exists() && ($(window).on("scroll", movableFunc), $movable.parent().on("click", movableFunc)), storage.movable = movableFunc
    }, initScrollTopLink = function() {
        var timeout_id, offset = 500,
            scroll_top_duration = 700,
            $back_to_top = $(".link-top"),
            bottomPoint = $(document).height() - $(window).height() - 150;
        $(window).scroll(function() {
            $(this).scrollTop() > offset ? $back_to_top.addClass("lt-is-visible") : ($back_to_top.removeClass("lt-is-visible pulse"), clearTimeout(timeout_id)), bottomPoint - $(this).scrollTop() < 0 && (timeout_id = setTimeout(function() {
                $back_to_top.addClass("pulse")
            }, 3e3))
    ...
    }, initFixedPage = function() {
        function getOrientation() {
            var isPortrait = !0;
            return window.innerHeight > window.innerWidth ? (isPortrait = !0, $(".wrapper").addClass("custom-portrait").removeClass("custom-landscape")) : (isPortrait = !1, $(".wrapper").removeClass("custom-portrait").addClass("custom-landscape")), isPortrait
        }

        function buildVideo640() {
            getOrientation() ? (buildVideoPortrait640(), $embed.css("width", "100%")) : ($wrapEmbed.css("top", 0), window.innerWidth / window.innerHeight > RATIO ? $embed.css("width", window.innerHeight * RATIO) : $embed.css("width", "100%"))
        }

        function buildVideoPortrait640() {
            heightTopFixedEmbed = $header.outerHeight(), $tags.exists() && (heightTopFixedEmbed += $tags.outerHeight()), $(window).scrollTop() <= heightTopFixedEmbed ? $wrapEmbed.css("top", heightTopFixedEmbed - $(window).scrollTop()).css("zIndex", 160) : $wrapEmbed.css("top", 0), $(window).scrollTop() <= 0 && $wrapEmbed.css("zIndex", 151)
        }

        function calcBottomFixed() {
            fixedBottomHeight = $fixedBottom.outerHeight(), $fixedResponsed.css("bottom", fixedBottomHeight)
        }

        function calcResponsedSizes() {
            fixedResponsedHeight = $fixedResponsed.outerHeight(), fixedResponsedWidth = $fixedResponsed.width()
        }

        function responsedVideo(fixedResponsedHeight, fixedResponsedWidth) {
            fixedResponsedWidth / fixedResponsedHeight > RATIO ? ($wrapEmbed.css("height", "100%"), $embed.css("width", fixedResponsedHeight * RATIO)) : ($wrapEmbed.css("height", fixedResponsedWidth / RATIO), $embed.css("width", "100%"))
        }

        function buildSpot() {
            var wrapEmbedHeight, freePlaceHeight;
            if (wrapEmbedHeight = $wrapEmbed.outerHeight(), freePlaceHeight = (fixedResponsedHeight - wrapEmbedHeight) / 2, freePlaceHeight > heightSpot) {
                var position = (freePlaceHeight - heightSpot) / 2;
                $spots.show(300), $(".spot-trailer.top").css("top", position), $(".spot-trailer.bottom").css("bottom", position)
            } else $spots.hide()
        }

        function execByScreenWidth(cbDesctop, cbTablet, cbMobile) {
            window.innerWidth > 1197 ? "function" == typeof cbDesctop && cbDesctop() : window.innerWidth < 786 ? "function" == typeof cbTablet && cbTablet() : "function" == typeof cbMobile && cbMobile()
        }
        ...
        var fixedBottomHeight, fixedResponsedHeight, fixedResponsedWidth, heightTopFixedEmbed, RATIO_WIDTH = 16,
            RATIO_HEIGHT = 9,
        ...
        $contentFixedReplacement = $(".page-layout_content-fixed-replacement"), heightSpot = $spots.outerHeight(), execByScreenWidth(function() {
            calcBottomFixed(), calcResponsedSizes(), responsedVideo(fixedResponsedHeight, fixedResponsedWidth), buildSpot(), setFixedHeight()
        }, function() {
            buildVideo640()
        }), $("#settings-toggle").click(function() {
            execByScreenWidth(function() {
                $wrapEmbed.addClass("animated"), calcBottomFixed(), calcResponsedSizes(), $(".wrapper").hasClass("show-filter") ? fixedResponsedWidth += filterWidth : fixedResponsedWidth -= filterWidth, responsedVideo(fixedResponsedHeight, fixedResponsedWidth), $spots.hide(), setTimeout(function() {
                    buildSpot()
                }, 1201)
            })
        }), $(window).resize(function() {
            execByScreenWidth(function() {
                $wrapEmbed.css("top", "50%"), $wrapEmbed.removeClass("animated"), calcBottomFixed(), calcResponsedSizes(), responsedVideo(fixedResponsedHeight, fixedResponsedWidth), buildSpot(), setFixedHeight()
            }, function() {
                buildVideo640()
            }, function() {
                $wrapEmbed.css("height", "auto"), $wrapEmbed.css("top", "auto"), $embed.css("width", "100%;")
            })
        }), $(window).scroll(function() {
            execByScreenWidth(function() {}, function() {
                buildVideo640()
            })
        })
        ...
        function fixBPos() {
            ...
            $fancyWrap = $(".fancybox-wrap"), heightAll = $(".fancybox-overlay").outerHeight(), heightFancybox = $fancyWrap.outerHeight(), heightPopup = $spotPopup.outerHeight(), topSpot = 0, (heightAll - heightFancybox) / 2 > heightPopup ? (topSpot = $fancyWrap.offset().top + heightFancybox,
                $spotPopup.css("top", topSpot), $spotPopup.show()) : $spotPopup.hide()
        }
        $(".fancybox").fancybox({
            padding: [35, 15, 15, 15],
            nextClick: !0,
        ...
        $(document).on("click", ".js__btn-popup", function(ev) {
            ...
            return $.fancybox.open({
                ...
                afterShow: function() {
                    ...
                    new Swiper(".popup-slider-container", {
                        nextButton: ".swiper-button-next",
                        prevButton: ".swiper-button-prev",
                        slidesPerView: "auto",
                        spaceBetween: 0,
        ...
        $("body").on("focus", '.wrap-list-selector [type="text"]', function() {
            $container = $(this).parents(".wrap-list-selector"), $popupContent = $container.find(".list-selector-popup"), $popupContent.exists() && ($popupContent.show(), $container.addClass("open"), $(".wrap-popup").find(".list-selector-popup-inner").mCustomScrollbar({
                theme: "minimal-dark"
            }))
        });
        var $opened = null;
        $(document).mouseup(function(e) {
            ...
            null === $opened ? $container.is(e.target) || 0 !== $container.has(e.target).length ? $opened = $(e.target).parents(".wrap-list-selector") : ($container.removeClass("open"), $opened = null, $(".list-selector-popup").hide()) : $opened.is(e.target) || 0 !== $opened.has(e.target).length || ($opened.removeClass("open"), $opened.find(".list-selector-popup").hide(), $opened = null)
        })
    }, initShareForm = function() {
        $("body").on("click", ".embed-button", function(e) {
            e.preventDefault();
            var embedWidth, embedHeight, embedSize = $(this).data("embed-size");
            "function" == typeof window.getEmbed && embedSize && embedSize.indexOf("x") > 0 && (embedWidth = parseInt(embedSize.substr(0, embedSize.indexOf("x"))), embedHeight = parseInt(embedSize.substr(embedSize.indexOf("x") + 1)), $(".embed-code").val(window.getEmbed(embedWidth, embedHeight)))
        }), $("body").on("keyup blur", ".embed-code-custom-width, .embed-code-custom-height", function() {
            var $widthField = $(".embed-code-custom-width"),
                $heightField = $(".embed-code-custom-height");
            parseInt($widthField.val()) && parseInt($heightField.val()) && ($(".ez-width").html(parseInt($widthField.val())), $(".ez-height").html(parseInt($heightField.val())), $(".embed-button-custom").data("embed-size", parseInt($widthField.val()) + "x" + parseInt($heightField.val())))
        })
    }, initCreatePlaylistsModal = function() {
        $("body").on("click", ".js__add-playlist", function() {
            return $("#wnd_create-plst").modal("show"), !1
        }), $("body").on("click", ".js__create-playlist", function() {
            var $this = $(this);
            $this.toggleClass("active"), $this.hasClass("active") ? $(".create-playlist").show() : $(".create-playlist").hide(), $.fancybox.update()
            ...
            return $.ajax({
                ...
                success: function(data) {
                    ...
                    if (errors)
                        for (var i = 0; i < errors.length; i++) - 1 != errors[i].indexOf('"title"') && (-1 != errors[i].indexOf('"required"') ? $("#error_playlist_1").show() : -1 != errors[i].indexOf('"exists"') && $("#error_playlist_2").show());
                    else {
                        $(".modal-content .form-content").text("Playlist was created");
                        var playlist_id = $(data).attr("data-playlist-id"),
                            video_id = $(".js__add-playlist").attr("data-video-id");
                        $.ajax({
                            url: "?mode=async&action=add_to_favourites&video_id=" + video_id + "&playlist_id=" + playlist_id
                        }), setTimeout(function() {
            ...
            $(this).prop("checked") ? $.ajax({
                ...
                url: "?mode=async&action=delete_from_favourites&video_id=" + video_id + "&playlist_id=" + playlist_id
            })
            ...
            $.ajax({
                url: url + "?mode=async&action=delete_from_favourites&video_id=" + video_id + "&playlist_id=" + playlist_id
            }), $this.parent().remove()
        })
    }, initMethods = [initFixedPage, initSelect, initNavbarCollapse, initSliders, initScroll, initMainMenu, initMasonry, initMagicLine, initRanges, initSubscribe, initMovable, initScrollTopLink, initFancyBox, initPopups, initListSelector, initShareForm, initCreatePlaylistsModal], i = 0; i < initMethods.length; i++)
        if ("function" == typeof initMethods[i]) try {
