  ...
  function myTemplateSelection(data) {
	...
	var initSelect = function () { 
		...
		$('.js__select-tags').select2({
		  ...
		  theme: "search",
		  allowClear: true,
		  tokenSeparators: [','], // [',', ' '] -- можно и по пробелам, но здесь не нужно
	...
	var initFixedPage = function() {
		...
		function getOrientation() {
			// Ф-я определяет ориентацию мобильного устройства
			// просто по сравнении высоты и ширины экрана
			// Вешает на .wrapper класс 
			// custom-landscape - если альбомная  раскладка 
			// custom-portrait  - если портретная раскладка 
			var isPortrait = true;
      ...
      if ($tags.exists()) {
		...
		function responsedVideo(fixedResponsedHeight, fixedResponsedWidth) {
			// Логика выстраивания видео внутри расстягиваемого блока.
			// Если ширина больше высоты по пропорции, то уменьшаем ширину плеера, а высота макс.
			// Иначе плеер на всю ширину а высота по пропорции.
		...
		function buildSpot() {
			// Выставляем банера если они помещаются.
			var wrapEmbedHeight,
					freePlaceHeight;
